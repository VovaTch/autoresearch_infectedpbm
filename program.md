...
3. **Read the in-scope files**: The repo is small. Read these files for full context:
   - `prepare.py` — data prep, loaders, and utility functions. Do not modift
   - `train.py` — the file you modify. Model architecture, optimizer, training loop, I use Pytorch Lightning
4. **Verify data exists**: Check that `~/.cache/infected_pbm/` contains the music slices.
...
```
  ...
  test/commitment_loss       15.3800048828125
   ...
   test/melspec_loss_3      0.12781472504138947
   test/melspec_loss_4      0.3675403594970703
   test/melspec_loss_5      0.28519952297210693
